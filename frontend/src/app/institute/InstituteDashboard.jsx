                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <CardDescription className="text-gray-600 mt-2">
                      Documents approved by higher authority, ready for minting
                      as blockchain certificates
                    </CardDescription>
                  </div>
                            ...
                            <div className="flex items-center space-x-3">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-gray-500">
                                  ID: DOC-{doc.id.toString().padStart(3, "0")}
                                </p>
                              </div>
                            </div>
                          </TableCell>
              ...
              <CardHeader className="pb-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <CardDescription className="text-gray-600 mt-2">
                      Soul Bound Tokens issued to students, permanently recorded
                      on blockchain
                    </CardDescription>
                  </div>
                  <Badge className="status-success">
                          ...
                          <TableCell className="font-medium text-gray-900">
                            <div className="flex items-center space-x-3">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-gray-500">
                                  SBT-{token.id.toString().padStart(3, "0")}
                                </p>
                              </div>
                            </div>
                          </TableCell>
          ...
          <div className="space-y-6 animate-fade-in">
            <Card className="glass-card shadow-xl">
              <CardHeader>
                ...
                <CardDescription>
                  Select a plan to purchase additional credits for document
                  processing
                </CardDescription>
              </CardHeader>
              <CardContent>
